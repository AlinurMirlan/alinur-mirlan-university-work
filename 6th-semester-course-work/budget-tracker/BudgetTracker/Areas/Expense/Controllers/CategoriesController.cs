...
namespace BudgetTracker.Areas.Expense.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public IActionResult Index(int page = 1)
        {
            ...
            var categories = incomeRepo.GetCategories(userId, EntryName.Expense, page, itemsPerPage, out int totalItems);
        ...
        public async Task<IActionResult> Index(CategoryDto categoryDto)
        {
            ...
            try
            {
                await incomeRepo.InsertCategoryAsync(category, EntryName.Expense);
            }
