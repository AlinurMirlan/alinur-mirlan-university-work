...
namespace BudgetTracker.Areas.Expense.Controllers
{
    ...
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            foreach (var category in incomeRepo.GetCategories(userId, EntryName.Expense))
            {
            ...
            var (totalItems, incomes) = await incomeRepo.GetEntriesAsync(order, userId, EntryName.Expense, page, itemsPerPage);
