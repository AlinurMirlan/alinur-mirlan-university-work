...
namespace BudgetTracker.Areas.Expense.Controllers
{
    ...
    public class ExpensesRecController : Controller
    {
        ...
        public ExpensesRecController(ILogger<ExpensesRecController> logger, EntryRepository entryRepo, IMapper mapper, IConfiguration config)
        {
        ...
        public async Task<IActionResult> Index(EntryRecFormVm incomeRecForm)
        {
            ...
            var userId = User.GetUserId();
            var income = mapper.Map<Entry>(incomeRecForm.EntryRecDto);
